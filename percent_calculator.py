...
def check_and_calculate(event=None):
    if entry_value1.get() and entry_value2.get() and operation_combobox_basic.get():
        basic_calculate()
...
entry_value2.bind('<Return>', check_and_calculate)
clear_button_basic.bind('<Return>', clear_basic)
